...
fun GenerateCode.logicalExtensions() {
    for ((`as`, name) in getTypeFileMapping("Logical")) {
//        println("generating logical extensions for $`as` ($name)")
        ...
        generateLogicalExtensions(`as`, name.first).writeTo(targetDir.asFile)
    }
}
...
fun generateLogicalExtensions(`as`: String, fileName: String): FileSpec {
